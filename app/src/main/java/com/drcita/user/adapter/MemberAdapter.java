...
public class MemberAdapter extends RecyclerView.Adapter<MemberAdapter.MemberViewHolder> {
    ...
    private  MembersListActivity context;


    public MemberAdapter(MembersListActivity membersListActivity, List<Member> members) {
    ...
    public void onBindViewHolder(@NonNull MemberViewHolder holder, int position) {
       ...
       holder. ll_child.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(context, ProfileUpdateActivity.class);
