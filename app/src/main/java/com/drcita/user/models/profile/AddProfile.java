...
public class AddProfile {
    ...
    public void setPastSurgeries(int pastSurgeries) { this.pastSurgeries = pastSurgeries; }
    ...
    public List<DiseaseStatus> getDiseases() { return diseases; }
    public void setDiseases(List<DiseaseStatus> diseases) { this.diseases = diseases; }

    public AddProfile(int userId, String fullName, int gender, int age, String dob,
                      int maritalStatus, String mobile, String email, int stateId, int cityId, String address, int pastSurgeries,
                      int bloodGroupId, int foodType, List<DiseaseStatus> diseases) {
        this.userId = userId;
